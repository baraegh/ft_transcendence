...
const arrayOfMsg00: msgListType =[
    ...
    {id: 2, sender: 'barae', msg: 'test 2 test 2 test 2 test 2test 2 test 2test 2 test 2test 2 test 2test 2 test 2test 2 test 2test 2 test 2test 2 test 2 test 2 test 2test 2 test 2test 2 test 2test 2 test 2test 2 test 2test 2 test 2test 2 test 2test 2 test 2 test 2 test 2test 2 test 2test 2 test 2test 2 test 2testtesttesttest 2 test 2test 2 test 2test 2 test 2t 2test 2 test 2test 2 test 2 test 2 test 2test 2 test 2test 2 test 2test 2 test 2testtesttesttest 2 test 2test 2 test 2test 2 test 2t 2test 2 test 2test 2 test 2 test 2 test 2test 2 test 2test 2 test 2test 2 test 2testtesttesttest 2 test 2test 2 test 2test 2 test 2t 2test 2 test 2test 2 test 2 test 2 test 2test 2 test 2test 2 test 2test 2 test 2testtesttesttest 2 test 2test 2 test 2test 2 test 2t 2test 2 test 2test 2 test 2 test 2 test 2test 2 test 2test 2 test 2test 2 test 2testtesttesttest 2 test 2test 2 test 2test 2 test 2t 2test 2 test 2test 2 test 2 test 2 test 2test 2 test 2test 2 test 2test 2 test 2testtesttesttest 2 test 2test 2 test 2test 2 test 2', time:'time', image:Image},
...
type msgType = {id: number, sender: string, msg: string, time: string, image?: string};
  ...
  return (
      <div className='chat-page'>
          {!isChatSettingOpen?
              (
                <>
                  <ChatHistoryList setChatId={setChatId} setIsProfileOpen={setIsProfileOpen} />
                  <div className='chat-area'>
                      {   
                          ((chatId === 0) || chatId !== null)?
                              <ChatArea ListOfMsg={chatArray[chatId].chat} 
